...
public class DateUtils {
    ...
    public static final String DATEFORMAT_YYYYMMDD_HHMMSS = "yyyyMMdd HHmmss";
    public static final String DATEFORMAT1_YYYY_MM_DD_HH_MM_SS = "yyyy-MM-dd HH:mm:ss";
    public static final String DATEFORMAT2_YYYY_MM_DD_HH_MM_SS = "yyyy/MM/dd HH:mm:ss";
    public static final String DATEFORMAT3_YYYY_MM_DD_HH_MM_SS = "yyyy年MM月dd日 HH时mm分ss秒";

   public static String format(Date date) {
        try {
            return DateFormatUtils.format(date, DateUtils.DATEFORMAT1_YYYY_MM_DD_HH_MM_SS);
        } catch (Exception e) {
            return null;
        }
    }
    ...
    // 获取前count天
    public static String getAddCountDay(int count, String day, String format) {

        SimpleDateFormat simpleDate2 = new SimpleDateFormat(format);
...
//        GregorianCalendar calendar2 = new GregorianCalendar();
    ...
    public static String getLastDayOfMonth(String date) {
        ...
        cal.set(Calendar.MONTH, Integer.parseInt(ss[1]) - 1);
